...
const Entry = () => {
  ...
  const {
    data: FirstEntry,
    isLoading: isLoadingFirstEntry,
    isError: isErrorFirstEntry,
  } = useGetLastEntry();
  ...
  // console.log("--------------addEntry--------------", entryData);
        ...
        <div className="flex p-6 flex-wrap border-gray-600 bg-white border-8 gap-10 m-auto justify-center">
          {formData.map((field) =>
            field.fieldType === fieldType.input ? (
              ...
              <div key={field.name} className="flex flex-col gap-1">
                <Label>{field.name}</Label>
                <Command className="rounded-lg border w-fit shadow-md relative overflow-visible">
                  <CommandInput
                    data-key="tab"
              ...
              <div key={field.name} className="flex flex-col gap-1">
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem
                      onKeyDown={(e) => keyDownDataSelect(e)}
                      data-item={NextSelect.typeItem}
                      data-type="okay"
                      value="peti"
                    >
                      Peti
              ...
              <div key={field.name} className="flex flex-col gap-1">
                ...
                <Select
                  ...
                  key={field.name}
                  name={field.name}
                  defaultValue={entryData[field.name] ? "true" : "false"}
                >
                  <SelectTrigger data-key="tab" className="w-20">
                    <SelectValue
                      data-key="tab"
